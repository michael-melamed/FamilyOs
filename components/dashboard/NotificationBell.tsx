...
export function NotificationBell({ householdId, hasRecentUpdate, currentUserId }: NotificationBellProps) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {isOpen && (
        <div className="fixed top-[60px] left-4 right-4 sm:absolute sm:top-full sm:left-0 sm:right-auto sm:mt-2 sm:w-96 bg-white text-calm-text rounded-2xl shadow-xl border border-neutral-100 overflow-hidden z-50 animate-in fade-in slide-in-from-top-4 duration-200 origin-top">
